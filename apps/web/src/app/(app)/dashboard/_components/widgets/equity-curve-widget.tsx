      ...
      <header className="flex flex-wrap items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <span
              className={cn(
                'rounded-2xs border px-2 py-0.5 font-mono text-xs font-bold tabular-nums',
                netR > 0
        ...
        <div className="flex items-center gap-1">
          {(['7d', '30d', 'all'] as const).map((tf) => (
            <button
              ...
              className={cn(
                'min-h-[30px] cursor-pointer touch-manipulation rounded-xs px-2.5 py-1 font-mono text-xs font-semibold uppercase transition-colors',
                timeframe === tf
