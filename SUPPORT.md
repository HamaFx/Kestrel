...
| [docs/deployment-matrix.md](docs/deployment-matrix.md)       | You need supported deployment profiles                         |
| [docs/audit/current-status.md](docs/audit/current-status.md) | You need current readiness status and release gates            |
