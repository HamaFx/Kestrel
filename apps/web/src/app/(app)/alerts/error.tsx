  ...
  return (
    <div className="flex flex-col items-center justify-center gap-5 px-6 py-16 text-center">
      ...
      <div className="flex max-w-xs flex-col gap-2">
        <p className="text-fg text-body font-semibold tracking-tight">Failed to load alerts</p>
        <p className="text-fg-muted text-body-sm leading-[1.4]">
          Something went wrong while loading your price alerts. Please try again.
        </p>
      </div>
      <button
        type="button"
